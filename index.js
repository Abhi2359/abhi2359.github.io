projectsList = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        badges: [{ name: "React Native", color: "bg-gray-700" }],
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        badges: [{ name: "React", color: "bg-gray-700" }],
      },
      {
        title: " Front End  Challenge",
        description:
